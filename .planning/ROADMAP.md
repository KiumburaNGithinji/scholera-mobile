...
**Plans**: 4 plans
  ...
  - [x] 04-03-dashboard-and-departments-PLAN.md — replace admin tab placeholder with real dashboard: 2×2 stats grid via StatCard + departments list with tap-through (ADMIN-01, ADMIN-02)
...
| 4. Admin Experience | 2/4 | In Progress | - |
